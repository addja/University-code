...
void Distort::onPluginLoad()
{
    ...
    vs->compileSourceFile("/home/user/git/tmp-files/OpenGL/Engine/plugins/distort/distort.vert");

    fs = new QGLShader(QGLShader::Fragment, this);
    fs->compileSourceFile("/home/user/git/tmp-files/OpenGL/Engine/plugins/distort/distort.frag");
