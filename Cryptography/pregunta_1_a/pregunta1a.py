...
cM = subprocess.check_output(["python", "aes_mod_p1a.py", texto])
cMi = subprocess.check_output(["python", "aes_mod_p1a.py", textoMi])
cMj = subprocess.check_output(["python", "aes_mod_p1a.py", textoMj])
cMij = subprocess.check_output(["python", "aes_mod_p1a.py", textoMij])
