...
if __name__ == "__main__":
    data = list(open('2015_03_13_daniel.otero.avalle.enc', 'r').read())
    key = list(open('2015_03_13_daniel.otero.avalle.key','r').read())
    print decryptData(key, data, AESModeOfOperation.modeOfOperation["CBC"])